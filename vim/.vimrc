...
" CoC extensions
let g:coc_global_extensions = ['coc-elixir', 'coc-tsserver', 'coc-json', 'coc-eslint', 'coc-prettier', 'coc-yaml', 'coc-styled-components', '@yaegassy/coc-volar']
